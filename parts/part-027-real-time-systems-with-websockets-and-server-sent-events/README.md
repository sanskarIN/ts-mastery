# Part 027 — Real-Time Systems with WebSockets and Server-Sent Events

**Book mapping:** TypeScript Full Mastery, Part 27.
...
Real-time delivery and reconnect exercise + tests.
