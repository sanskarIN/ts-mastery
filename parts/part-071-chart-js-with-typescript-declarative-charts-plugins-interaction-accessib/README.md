# Part 071 — Chart.js with TypeScript: Declarative Charts, Plugins, Interaction, Accessibility, Testing, and Production Dashboards
...
**Book mapping:** TypeScript Full Mastery, Part 71.
...
Testing, build, deployment, or desktop/mobile lab.
